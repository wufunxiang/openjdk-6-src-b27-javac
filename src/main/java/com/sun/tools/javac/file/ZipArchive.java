...
public class ZipArchive implements Archive {
	...
	void addZipEntry(ZipEntry entry) {
		...
		RelativeDirectory dirname = new RelativeDirectory(name.substring(0,
				i + 1));
	...
	public static class ZipFileObject extends BaseFileObject {
		...
		/**
		 * Check if two file objects are equal. Two ZipFileObjects are equal if
		 * the absolute paths of the underlying zip files are equal and if the
		 * paths within those zip files are equal.
		 */
		// @Override
