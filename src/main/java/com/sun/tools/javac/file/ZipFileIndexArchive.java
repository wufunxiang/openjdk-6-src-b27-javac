...
public class ZipFileIndexArchive implements Archive {
	...
	public static class ZipFileIndexFileObject extends BaseFileObject {
		...
		ZipFileIndexFileObject(JavacFileManager fileManager,
				ZipFileIndex zfIndex, ZipFileIndex.Entry entry, File zipFileName) {
			super(fileManager);
		 ...
		 * equal if the absolute paths of the underlying zip files are equal and
		 * if the paths within those zip files are equal.
		 */
		// @Override
		public boolean equals(Object other) {
			...
			return zfIndex.getAbsoluteFile()
					.equals(o.zfIndex.getAbsoluteFile()) && name.equals(o.name);
		}
