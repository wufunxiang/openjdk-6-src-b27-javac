...
public class Messages {
	...
	protected static final Context.Key<Messages> messagesKey = new Context.Key<Messages>();
	 ...
	 * 
	 * @param bundle
	 *            the name to identify the resource buundle of localized
	 *            messages.
	 */
	 ...
	 * 
	 * @param bundle
	 *            the name to identif the resource buundle of localized
	 *            messages.
	 */
	 ...
	 * 
	 * @param bundle
	 *            the name to identify the resource bundle of localized
	 *            messages.
	 */
	...
	/**
	 * Add a new resource bundle to the list that is searched for localized
	 * messages. Resource bundles will be searched in reverse order in which
	 * they are added.
	 * 
	 * @param bundle
	 *            the bundle of localized messages.
	 */
