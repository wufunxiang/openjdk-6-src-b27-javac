...
public class WrappingJavaFileManager<M extends JavaFileManager> extends
	...
	/**
	 * This implementation returns the given file object. Subclasses may
	...
	/**
	 * This implementation forwards to {@link #unwrap(FileObject)}. Subclasses
	...
	/**
	 * This implementation maps the given list of file objects by calling wrap
	 * on each. Subclasses may override this behavior.
	 * 
	 * @param fileObjects
