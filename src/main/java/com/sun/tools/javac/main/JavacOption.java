...
public interface JavacOption {
	...
	static class Option implements JavacOption {
		...
		Option(OptionName name, String argsNameKey, String descrKey) {
			...
			char lastChar = name.optionName
					.charAt(name.optionName.length() - 1);
		...
		public boolean matches(String arg) {
			return hasSuffix ? arg.startsWith(name.optionName) : arg
					.equals(name.optionName);
		}
		...
		/**
		 * Print a line of documentation describing this option, if
		 * non-standard.
		 */
